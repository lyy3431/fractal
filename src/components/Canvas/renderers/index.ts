// 分形图形渲染器
export { renderMandelbrot } from './mandelbrot';
export { renderJulia } from './julia';
export { renderSierpinski } from './sierpinski';
export { renderNewton } from './newton';
export { renderBurningShip } from './burningShip';
export { renderPhoenix } from './phoenix';
export { renderSierpinskiCarpet } from './sierpinskiCarpet';
